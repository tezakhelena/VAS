...
s2s_secure_domains = { "localhost" }

-- Select the authentication backend to use. The 'internal' providers
-- use Prosody's configured data storage to store the authentication data.

authentication = "internal_hashed" --internal_hashed
...
VirtualHost "10.5.0.2"
VirtualHost "prosody_prosody_1"
VirtualHost "prosody"
VirtualHost "f4316750a33c"

--VirtualHost "0.0.0.0"

--VirtualHost "vas.server"
